...
from nanuda.views import KakaoLogin, userInfoName, uploadAddress, checkAddress, serviceReviewOrNOt, orderUpload, niceMain,logout,bankUpload,bankCheck,getOrder
...
urlpatterns = [
    ...
    path('getOrder/', getOrder.as_view(), name='getOrder'),
]
